            ...
            when(button){
                1 -> {
                    binding.bodyColorOneBtn.setOnClickListener {
                        CharacterFixActivity.character_init_body_color = 1
                ...
                2 -> {
                    binding.bodyColorTwoBtn.setOnClickListener {
                        CharacterFixActivity.character_init_body_color = 2
                        character_body_binding.userCharacterInit.body.setColorFilter(resources.getColor(
                ...
                3 -> {
                    binding.bodyColorThreeBtn.setOnClickListener {
                        CharacterFixActivity.character_init_body_color = 3
                ...
                4 -> {
                    binding.bodyColorFourBtn.setOnClickListener {
                        CharacterFixActivity.character_init_body_color = 4
                        character_body_binding.userCharacterInit.body.setColorFilter(
                            resources.getColor(
                                R.color.body_red
                            )
                ...
                5 -> {
                    binding.bodyColorFiveBtn.setOnClickListener {
                        CharacterFixActivity.character_init_body_color = 5
                        character_body_binding.userCharacterInit.body.setColorFilter(
                            resources.getColor(
                                R.color.body_yellow
                            )
